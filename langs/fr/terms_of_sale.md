...
* **Obligation d'attribution et mention de marque (« Powered by Niwer's Engine ») :** 
  En contrepartie des droits d'utilisation et d'accès concédés (incluant le Developer Access), le Licencié s'engage expressément à maintenir de manière visible et non altérée les crédits et mentions de paternité logicielle de Niwer's Engine.
  * **Dans le jeu / l'interface :** La mention « Powered by Niwer's Engine » (ou le logo officiel fourni) doit obligatoirement figurer dans les menus principaux du projet, les interfaces de chargement ou les crédits accessibles aux utilisateurs finaux.
  * **Supports de communication et vidéos :** Pour toute vidéo de présentation, bande-annonce officielle, documentation publique ou page web faisant la promotion du serveur ou du jeu exploitant le Logiciel, le Licencié s'engage à mentionner explicitement que le projet est propulsé par Niwer's Engine, accompagné d'un lien renvoyant vers `niwer.dev`.
  * **Interdiction d'usurpation de paternité :** Le Licencié s'interdit formellement de masquer, supprimer, modifier ou s'attribuer la conception, le développement ou la paternité intellectuelle du framework et du moteur sous-jacent.
